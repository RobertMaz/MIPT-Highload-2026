...
На семинаре вы получите неполное описание реальной highload-системы и будете работать в группах. Задачи:

1. Сформулировать НФТ измеримо — в формате `SLI + оператор + SLO + условия`
2. Оценить архитектурную значимость каждого НФТ
3. Рассчитать пиковый RPS — по формуле выше
4. Составить бюджет задержки (latency budget) для 1 критичного пути
